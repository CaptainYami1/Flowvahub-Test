...
export const Tab = ({ name, activeTab, setActiveTab, amount }: TabProps) => {
  return (
    <div
      className={`flex flex-row items-center gap-2 px-3 py-3 transition-all duration-300 ease-in-out hover:bg-purple-100 rounded-t-lg cursor-pointer text-base leading-6 whitespace-nowrap font-[var(--font-family-ui)] ${
        activeTab === name
