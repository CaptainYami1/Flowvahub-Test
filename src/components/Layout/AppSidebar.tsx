...
export const AppSidebar = () => {
  ...
  return (
    ...
    >
      <div
        className="px-4 py-3 flex flex-col bg-white  w-72 overflow-x-hidden  h-screen shadow-md border-r border-black/10 text-black font-(--font-family-ui)"
      >
        ...
        <div className="">
          {SidebarItems.map((item) => (
            <div
              key={item.name}
              className={`flex items-center gap-3 px-4 p-3 mb-2 rounded-lg font-family-ui cursor-pointer  duration-200 transition-all
                ${
