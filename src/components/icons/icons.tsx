  ...
  return (
    <>
      <svg
        ...
        data-prefix="fas"
        data-icon="house"
        className="w-4 svg-inline--fa fa-house "
        role="img"
  ...
  return (
    <>
      <svg
        ...
        data-prefix="fas"
        data-icon="compass"
        className="w-4 svg-inline--fa fa-compass "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
  ...
  return (
    <>
      <svg
        ...
        data-prefix="fas"
        data-icon="box-open"
        className="w-4 svg-inline--fa fa-box-open "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
  ...
  return (
    <>
      <svg
        ...
        className="w-4 svg-inline--fa fa-layer-group "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512"
      >
  ...
  return (
    <>
      <svg
        ...
        className="w-4 svg-inline--fa fa-credit-card "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512"
      >
  ...
  return (
    <>
      <svg
        ...
        data-prefix="fas"
        data-icon="gem"
        className="w-4 svg-inline--fa fa-gem "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
  ...
  return (
    <>
      <svg
        ...
        data-prefix="fas"
        data-icon="user-gear"
        className="w-4 svg-inline--fa fa-user-gear "
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
      >
...
export const NotificationIcon = () => {
  return (
    <svg
      ...
      height="1em"
      viewBox="0 0 24 24"
      className=" w-6 h-6 text-[#2D3748] hover:text-primary"
    >
