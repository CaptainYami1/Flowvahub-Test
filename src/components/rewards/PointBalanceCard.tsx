    ...
    <Card variant="shadow">
      <CardHeader className="p-4 relative border border-b-[#f3f4f6] bg-[#eef2ff] border-t-0 border-r-0 border-l-0">
        <CardTitle className="text-lg font-semibold flex items-center gap-2 text-gray-700">
          <svg
            ...
            data-prefix="fas"
            data-icon="award"
            className="svg-inline--fa fa-award h-5 w-5 text-primary"
            role="img"
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-center">
          <span className="font-extrabold text-[36px] text-primary m-[10px_0] font-ui" >
            {balance}
          </span>
          <div className="bg-transparent w-25 h-25">
            ...
            >
              <defs>
                ...
                <mask id="__lottie_element_101_1" maskUnits="userSpaceOnUse">
                  <use xlinkHref="#__lottie_element_101"></use>
                </mask>
              </defs>
              <g clip-path="url(#__lottie_element_76)">
                ...
                <g
                  mask="url(#__lottie_element_101_1)"
                  style={{ display: "block" }}
                >
                  <g
                ...
                <g
                  style={{ display: "block" }}
                  transform="matrix(1.3428767919540405,1.4820510149002075,-1.4820510149002075,1.3428767919540405,450.27349853515625,-93.56828308105469)"
                  opacity="0.01870000000115141"
                >
                  <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                    <path
                ...
                <g
                  style={{ display: "block" }}
                  transform="matrix(0.8046227693557739,1.3829066753387451,-1.3829066753387451,0.8046227693557739,237.6714324951172,105.97087097167969)"
                  opacity="0.02003333333261054"
                >
                  <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                    <path
        ...
        <div className="mt-4">
          <div className="flex justify-between text-sm mb-1">
            ...
            <span className="font-medium">{balance}/5000</span>
          </div>
          <Progress
            value={progress}
