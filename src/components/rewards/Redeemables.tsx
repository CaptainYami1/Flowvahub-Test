      ...
      <Card variant="redeemable">
        <div className="flex flex-col items-center justify-center gap-4 font-(--font-family-ui)">
          ...
          <div className="flex flex-col gap-2 items-center justify-center">
            ...
            <p className="text-center text-[0.9rem] text-[#2D3748]">
              {description}
            </p>
          </div>
          <p className="flex items-center justify-center text-primary font-semibold mb-4">
            ⭐ {point} pts
          </p>
          <button
            disabled={disabled}
            onClick={onClick}
            className={`w-full font-semibold p-3 rounded-lg transition-all duration-300 ease-in-out  text-white ${
              redeem ? "bg-primary" : "bg-[#d7e0ed]"
            }`}
          >
            {button}
          </button>
